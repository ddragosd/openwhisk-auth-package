...
create-cache-package:
	...
	wsk action update $(CACHE_PACKAGE_NAME)/persist ./node_modules/openwhisk-cache-redis/openwhisk-cache-redis-0.0.2.js --param redis_host //10.0.2.159:6380
...
other:
	...
	# wsk action update oauth/github ./openwhisk-passport-auth-0.0.2.js --param auth_provider github --param client_id XXXXXXX --param client_secret XXXXX --param callback_url https://runtime-preview.adobe.io/api/v1/web/guest/oauth/github_com.json

	# oauth/adobe action can be created with:
	# wsk action update oauth/adobe ./openwhisk-passport-auth-0.0.2.js --param auth_provider adobe-oauth2 --param auth_provider_name adobe --param client_id XXXXX --param client_secret XXXXXX --param scopes openid,AdobeID --param callback_url https://runtime-preview.adobe.io/api/v1/web/guest/oauth/adobe_com.json
	# wsk action update oauth/adobe_com --sequence oauth/adobe,cache/encrypt,cache/redis --web true

	# cache/redis has been created with:
	# wsk action create cache/redis ./openwhisk-cache-redis-0.0.2.js --param redis_host //10.0.2.159:6380
